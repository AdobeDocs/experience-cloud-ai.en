...
Before installing, confirm that your organization and user account can access the product tools you need. See [Access CX Coworker Gateway tools](access.md).
...
1. Add the endpoint URL: `https://cx-coworker-gateway.adobe.io/mcp`.
...
1. An administrator adds the CX Coworker Gateway endpoint once for the organization.
...
4. Enter `https://cx-coworker-gateway.adobe.io/mcp` as the server URL and use a recognizable name, such as "Adobe for  CX Coworker Gateway".
...
4. Enter `https://cx-coworker-gateway.adobe.io/mcp` as the server URL.
...
2. Find the  CX Coworker Gateway connector and enable it.
...
3. Enter `https://cx-coworker-gateway.adobe.io/mcp` as the server URL.
