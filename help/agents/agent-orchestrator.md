...
| --- | --- | --- |
| [Adobe Marketing Agent for [!DNL Microsoft 365 Copilot]](ama-ms.md) | Instantly retrieve marketing insights from Adobe Experience Platform in [!DNL Microsoft 365] apps like [!DNL Teams], [!DNL Word], [!DNL Powerpoint], and [!DNL Excel]. With this agent, you can maintain chat history across apps and seamlessly continue your conversation as you work. | |
