...
Customer eligibility for the trial is fully at Adobe's discretion. The trial is not available to customers who have or had a license to Experience Platform Agents AI Credits.
...
>[!IMPORTANT]
>
>- The trial ends when Customer consumes its initial one-time allotment of 10,000 AI Credits or separately purchases a license to additional AI Credits, whichever comes first. AI Credits only exist for the duration of the trial experience and do not roll over if Customer purchases additional AI Credits before using the full 10,000 AI Credit trial allotment.  While Customer may not immediately lose access or be charged overages, the extension of those benefits is at Adobe's discretion, and Customer must purchase additional AI Credits as soon as the trial is complete in order to continue using Coworker Chat (or Adobe Experience Platform Agents) without disruption.
>
>- Adobe reserves the right to suspend or terminate Customer's access to Coworker Chat (or Adobe Experience Platform Agents) at any time and for any reason. Adobe may revoke or otherwise make changes to the trial at its discretion at any time.

## Access guide

### Access Coworker Chat

Users of eligible customers will have default access to Coworker Chat as part of the trial, so no action is needed. Coworker Chat operates under user guidance and oversight, and respects your organization's existing product-level access controls. Users can only take actions they a're already permitted to take within their organization's underlying CX Enterprise products.
...
For customers who have not been transitioned to Coworker Chat:

### Access Experience Platform Agents through AI Assistant powered by Agent Orchestrator
...
The Agentic usage-bound trial lets eligible customers use Coworker Chat (or select Experience Platform Agents) at no additional cost up to 10,000 AI Credits. The goal is to provide a low‑friction, low‑risk path to experience value from these agents before customers make a commercial decision.
...
This trial does not require any additional purchase. There is no automatic conversion to a paid offering. If a customer decides to continue using Coworker Chat (or Experience Platform Agents) beyond the trial, the Adobe account team will work with the customer to transition to the paid offering. 
...
Customers remain in control of who can see usage and reporting. Only administrators and users with the appropriate permissions can see this information. 
...
- Not move forward
  - Trial access will expire. 
  - Your existing Adobe products continue working as before, without penalty for not converting the trial
- Move forward with continued Coworker Chat (or Experience Platform Agent) usage
